...
static const char *__pyx_f[] = {
  "ctpn/ctpnlib/utils/cython_nms.pyx",
  "__init__.pxd",
  "type.pxd",
};
...
static const char __pyx_k_root_home_ai_006_OCR1_ctpn_ctpn[] = "/root/home/ai/006-OCR1/ctpn/ctpnlib/utils/cython_nms.pyx";
 ...
 */
  ...
  /* "ctpn/ctpnlib/utils/cython_nms.pyx":25
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)
 *     cdef np.ndarray[np.intp_t, ndim=1] order = scores.argsort()[::-1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ctpn/ctpnlib/utils/cython_nms.pyx":27
 *     cdef np.ndarray[np.intp_t, ndim=1] order = scores.argsort()[::-1]
 * 
 *     cdef int ndets = dets.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "ctpn/ctpnlib/utils/cython_nms.pyx":29
 *     cdef int ndets = dets.shape[0]
 *     cdef np.ndarray[np.intp_t, ndim=1] suppressed = \
 *             np.zeros((ndets), dtype=np.int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ctpn/ctpnlib/utils/cython_nms.pyx":42
 ...
 */
      ...
      __pyx_v_xx1 = __pyx_f_4ctpn_7ctpnlib_5utils_10cython_nms_max(__pyx_v_ix1, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x1.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_x1.diminfo[0].strides)));
 ...
 */
      ...
      __pyx_v_yy1 = __pyx_f_4ctpn_7ctpnlib_5utils_10cython_nms_max(__pyx_v_iy1, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y1.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_y1.diminfo[0].strides)));
 ...
 */
      ...
      __pyx_v_xx2 = __pyx_f_4ctpn_7ctpnlib_5utils_10cython_nms_min(__pyx_v_ix2, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x2.rcbuffer->pybuffer.buf, __pyx_t_32, __pyx_pybuffernd_x2.diminfo[0].strides)));
 ...
 */
      ...
      __pyx_v_yy2 = __pyx_f_4ctpn_7ctpnlib_5utils_10cython_nms_min(__pyx_v_iy2, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y2.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_y2.diminfo[0].strides)));
 ...
 */
  ...
  /* "ctpn/ctpnlib/utils/cython_nms.pyx":68
 *                 suppressed[j] = 1
 * 
 *     return keep             # <<<<<<<<<<<<<<
 * 
...
/* "ctpn/ctpnlib/utils/cython_nms.pyx":70
 *     return keep
 * 
 * def nms_new(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 ...
 */
  ...
  /* "ctpn/ctpnlib/utils/cython_nms.pyx":77
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.intp_t, ndim=1] order = scores.argsort()[::-1]
 ...
 */
  ...
  /* "ctpn/ctpnlib/utils/cython_nms.pyx":80
 *     cdef np.ndarray[np.intp_t, ndim=1] order = scores.argsort()[::-1]
 * 
 *     cdef int ndets = dets.shape[0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.intp_t, ndim=1] suppressed = \
 ...
 */
  ...
  /* "ctpn/ctpnlib/utils/cython_nms.pyx":82
 *     cdef int ndets = dets.shape[0]
 *     cdef np.ndarray[np.intp_t, ndim=1] suppressed = \
 *             np.zeros((ndets), dtype=np.int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ctpn/ctpnlib/utils/cython_nms.pyx":95
 *     cdef np.float32_t inter, ovr
 * 
 *     keep = []             # <<<<<<<<<<<<<<
 *     for _i in range(ndets):
 ...
 */
  ...
  /* "ctpn/ctpnlib/utils/cython_nms.pyx":123
 *                 suppressed[j] = 1
 * 
 *     return keep             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __pyx_codeobj__30 = (PyObject*)__Pyx_PyCode_New(2, 0, 29, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__29, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_root_home_ai_006_OCR1_ctpn_ctpn, __pyx_n_s_nms, 17, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__30)) __PYX_ERR(0, 17, __pyx_L1_error)
...
#endif
{
  ...
  /* "ctpn/ctpnlib/utils/cython_nms.pyx":9
 * 
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4ctpn_7ctpnlib_5utils_10cython_nms_3nms_new, NULL, __pyx_n_s_ctpn_ctpnlib_utils_cython_nms); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init ctpn.ctpnlib.utils.cython_nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
